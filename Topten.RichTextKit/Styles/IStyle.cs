...
namespace Topten.RichTextKit.Styles
{
    ...
    public interface IStyle
    {
        ...
        /// Color of the halo
        /// </summary>
        SKColor? HaloColor { get; init;}

        /// <summary>
        /// Width of halo
        /// </summary>
        float? HaloWidth { get; init;}

        /// <summary>
        /// Blur of halo
        /// </summary>
        float? HaloBlur { get; init;}

        /// <summary>
        /// Extra spacing between each character
        /// </summary>
        float? LetterSpacing { get; init;}

        /// <summary>
        /// The font variant (ie: super/sub-script) for text in this run.
        /// </summary>
        FontVariant? FontVariant { get; init;}

        /// <summary>
        /// Text direction override for this span
        /// </summary>
        TextDirection? TextDirection { get; init;}

        /// <summary>
        /// Specifies a replacement character to be displayed (password mode)
        /// </summary>
        char? ReplacementCharacter { get; init;}

        /// <summary>
        /// Key used to identify this style
        /// </summary>
        string StyleKey { get; }
    }
}
